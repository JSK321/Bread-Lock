  ...
  render() {
    return (
      <div>
        ...
        <button className="uk-button uk-button-secondary uk-button-large uk-width-1-3" style={{background: "#998e7d",marginBottom:"2%"}}>
          <Link
            to={"/foodbankqueue/" + this.state.FoodBankId} style={{color:"white", fontStyle:"bolder"}}
          >
            Incoming Orders
          </Link>
        </button>
