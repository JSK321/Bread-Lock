...
export default function FoodBankDetails(props) {
    return (
            ...
            <div className="uk-card uk-card-default uk-width-1-2@m">
                <div className="uk-card-header">
                    <div className="uk-grid-small uk-flex-middle">
                        ...
                        <div className="uk-width-expand">
                            <h1 className="uk-card-title uk-margin-remove-bottom" style={{ textAlign: "center" }}>Food Bank Information</h1>
                        </div>
                    </div>
                </div>
                <div class="uk-flex uk-flex-center">
                    <div class="uk-card uk-card-default uk-width-expand">
                        <ul>
                            <li>Food Bank: {props.showData ? (props.bankName) : null}</li>
                            <br></br>
                            ...
                            <br></br>
                            {/* <li>Hours: {props.showData ? (props.operationHours) : null}</li> */}
                        </ul>
                    </div>
                </div>
            </div>
